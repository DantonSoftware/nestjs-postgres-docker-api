...
export class InitSchema1775953855467 implements MigrationInterface {
    name = 'InitSchema1775953855467'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "posts" ("id" SERIAL NOT NULL, "title" character varying(150) NOT NULL, "content" text NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`);
